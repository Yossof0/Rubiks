...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.yt-thumb').forEach(div => {
        div.addEventListener('click', function() {
            ...
            this.outerHTML = `<iframe width="320" height="180" src="https://www.youtube.com/embed/${ytid}" frameborder="0" allowfullscreen></iframe>`;
        });
    });
});
...
// --- Spacebar logic: Only when timer section is visible ---
let spaceDown = false;
...
document.addEventListener('keydown', function(e) {
    ...
    if (
        e.code === 'Space' &&
        timerSection &&
        timerSection.classList.contains('active') &&
        !spaceDown &&
...
// Only use touchend for touch devices
